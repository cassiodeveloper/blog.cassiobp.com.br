    ...
    if ( !empty($slides) ) : $exl_posts = Array(); ?>
        ...
        <div class="slide clear">
            <div class="post">
                ...
                <div class="post-meta">por <span class="post-author"><a href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) ); ?>" title="Posts por <?php the_author(); ?>"><?php the_author(); ?></a></span> em <span
                        class="post-date"><?php the_time(__('M j, Y')) ?></span> &bull; <?php comments_popup_link(__('Sem comentários'), __('1 Comentário'), __('% Comentários'), '', __('Comentários fechados') ); ?> <?php edit_post_link( __( 'Editar post'), '&bull; '); ?></div>

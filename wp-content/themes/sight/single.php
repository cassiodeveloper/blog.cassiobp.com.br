            ...
            <div <?php post_class('single clear'); ?> id="post_<?php the_ID(); ?>">
                <div class="post-meta">
                    ...
                    por <span class="post-author"><a href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) ); ?>" title="Posts por <?php the_author(); ?>"><?php the_author(); ?></a></span> em <span
                        class="post-date"><?php the_time(__('M j, Y')) ?></span> &bull; <span><?php the_time() ?></span> <?php edit_post_link( __( 'Editar post'), '&bull; '); ?><a
                        href="#comments" class="post-comms"><?php comments_number(__('Sem comentários'), __('1 Comentário'), __('% Comentários'), '', __('Comentários fechados') ); ?></a></div>
